...
int main()
{
   ...
   while(1)
   {
 	 bzero(recv_buf, recv_MAXBUF + 1);/* 接收对方发过来的消息，最多接收 MAXBUF 个字节 */
 	 int len = recv(sockfd, recv_buf, recv_MAXBUF, 0);/* 接收服务器来的消息 */
 	 if(len > 0)
